...
public class rap_cs : MonoBehaviour
{
	...
	void Update ()
	{
		...
		else //Human
		{
			...
			if (anim.GetCurrentAnimatorStateInfo (0).IsName("Rap|SleepLoop") ||
			    ...
			    anim.GetCurrentAnimatorStateInfo (0).IsName("Rap|GroundAttack")) reset = true; else reset = false;
...
//Bone rotations, model modification and stick to the terrain
	void LateUpdate()
	{
		...
		if (anim.GetCurrentAnimatorStateInfo (0).IsName("Rap|SleepLoop")||
		    ...
		    anim.GetCurrentAnimatorStateInfo (0).IsName("Rap|Sleep-")||
		    anim.GetCurrentAnimatorStateInfo (0).IsName("Rap|Die")) rg.isKinematic=true; else rg.isKinematic=false;
