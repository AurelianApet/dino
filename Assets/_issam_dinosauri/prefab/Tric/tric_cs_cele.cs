...
public class tric_cs_cele : MonoBehaviour
{
...
//			else anim.SetInteger ("Idle", 0);
		...
		//Running Attack
			...
			if (anim.GetNextAnimatorStateInfo (0).IsName ("Tric|Stand2A"))
				velZ = 0.0F;
		...
		if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Tric|Walk") ||
			...
			if (soundplayed == false && (animcount == 8 || animcount == 22)) {
				...
				soundplayed = true;
			} else if (animcount != 8 && animcount != 22)
				soundplayed = false;
			...
			if (animcount == 3 && soundplayed == false) {
				...
				soundplayed = true;
			} else if (animcount != 3 && animcount != 20 && animcount != 25)
				soundplayed = false;
			...
			if (animcount == 4 && soundplayed == false) {
				...
				source.PlayOneShot (onwater ? Medsplash : Medstep, 1.0f);
				soundplayed = true;
			} else if (animcount != 4 && animcount != 20 && animcount != 25)
				soundplayed = false;
			...
			if (animcount == 20 && soundplayed == false) {
				...
				soundplayed = true;
			} else if (animcount != 5 && animcount != 11 && animcount != 20)
				soundplayed = false;
			...
			if (animcount == 20 && soundplayed == false) {
				...
				source.PlayOneShot (Sniff2, 0.5f);
				soundplayed = true;
			} else if (animcount != 11 && animcount != 20)
				soundplayed = false;
			...
			if (animcount == 2 && soundplayed == false) {
				...
				source.PlayOneShot (Tric2, 1.0f);
				soundplayed = true;
			} else if (animcount != 2 && animcount != 10 && animcount != 14)
				soundplayed = false;
