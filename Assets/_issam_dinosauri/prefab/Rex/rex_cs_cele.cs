...
public class rex_cs_cele : MonoBehaviour
{
	...
	public AudioClip Bigstep, Largesplash, Idlecarn, Carngrowl1, Carngrowl2, Bite, Swallow, Sniff1, Rex1, Rex2;
	public Texture2D[] skin, eyes;
...
//			}
			...
			if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|EatA") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|EatB") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|EatC") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Die1") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Die2") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|SleepLoop") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand2B") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand2D"))
				reset = true;
			else
				reset = false;
		}
		...
		//Walking
		if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Walk") ||
		    anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Walk") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|WalkGrowl") ||
		    anim.GetNextAnimatorStateInfo (0).IsName ("Rex|WalkGrowl") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|WalkToStand2") ||
		    anim.GetNextAnimatorStateInfo (0).IsName ("Rex|WalkToStand2") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand1ToWalk") ||
		    anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand1ToWalk") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand2ToWalk") ||
		    anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand2ToWalk")) {
			if (!anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand1A") &&
			    !anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand2A"))
			...
			if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|WalkToStand2") &&
			    anim.GetCurrentAnimatorStateInfo (0).normalizedTime > 0.6)
				velZ = 0.0F;
			
			
			if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|RunToStand1") &&
			    anim.GetCurrentAnimatorStateInfo (0).normalizedTime > 0.7)
				velZ = 0.0F;
			else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|RunToStand1") && (velZ > 0.0F))
				velZ = velZ - (Time.deltaTime * 0.25F);

			if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|EatA"))
				velZ = 0.0F;
		...
		//Backward steps
		else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step1-") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step2-") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step2-") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step1-") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step1ToStand2B") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step1ToStand2B") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step1ToStand2D") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step1ToStand2D") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step1ToSleep") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step1ToSleep")) {
		...
		//Forward steps
		         ...
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step2+") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step1+") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step2ToStand1C") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step2ToStand1C") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step2ToEatA") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step2ToEatA") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step2ToEatC") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step2ToEatC")) {
		...
		//Attack Steps 
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step1Attack") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step1Attack") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Step2Attack") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step2Attack")) {
			if (velZ < 0.5F)
				velZ = velZ + (Time.deltaTime * 1.5F);
		...
		//Strafe+
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Strafe1+") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Strafe1+") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Strafe2-") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Strafe2-")) {
			velZ = 0.1f;
			transform.rotation *= Quaternion.AngleAxis (ang, new Vector3 (0, 1, 0));
		...
		//Running
		else if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Run") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Run") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|RunAttackA") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|RunAttackA") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|RunAttackB") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|RunAttackB") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|WalkAttackA") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|WalkAttackA") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|WalkAttackB") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|WalkAttackB") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|RunGrowl") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|RunGrowl") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand1ToRun") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand1ToRun") ||
		         anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand2ToRun") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand2ToRun")) {
			transform.rotation *= Quaternion.AngleAxis (ang, new Vector3 (0, 1, 0));
			
			if (velZ > 0.6F && (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|RunGrowl") ||
			    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|RunGrowl")))
				velZ = velZ - (Time.deltaTime * 0.5F);
		...
		//Stop
		else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand1A") ||
		         anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand2A")) {
			velZ = 0.0F;
		...
		if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand1B")) {
			if (animcount == 0 && soundplayed == false) {
				source.pitch = Random.Range (1.0F, 1.25F);
				source.PlayOneShot (Rex1, 1.0f);
				soundplayed = true;
			} else if (animcount != 0)
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand1C")) {
			...
			if (animcount == 20 && soundplayed == false) {
				...
				soundplayed = true;
			} else if (animcount != 10 && animcount != 15 && animcount != 20)
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand2B")) {
			...
			if (animcount == 15 && soundplayed == false) {
				...
				source.PlayOneShot (Bite, 0.4f);
				soundplayed = true;
			} else if (animcount != 5 && animcount != 10 && animcount != 15)
				soundplayed = false;
		} else if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand2C")) {
			if (animcount == 0 && soundplayed == false) {
				source.pitch = Random.Range (1.0F, 1.25F);
				source.PlayOneShot (Rex2, 1.0f);
				soundplayed = true;
				...
				soundplayed = false;
		} else if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Stand2D")) {
			if (animcount == 0 && soundplayed == false) {
				source.pitch = Random.Range (1.0F, 1.25F);
				...
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|SleepLoop") ||
		           anim.GetNextAnimatorStateInfo (0).IsName ("Rex|EatA") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|EatA")) {
			if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|EatA")) {
				if (animcount == 5 && soundplayed == false) {
					source.pitch = Random.Range (1.0F, 1.25F);
			...
			if (animcount == 15 && soundplayed == false) {
				...
				soundplayed = true;
			} else if (animcount != 5 && animcount != 15)
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Strafe1+") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Strafe1-") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Strafe2+") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Strafe2-")) {
			if (animcount == 13 && soundplayed == false) {
				...
				source.PlayOneShot (onwater ? Largesplash : Bigstep, 0.5f);
				soundplayed = true;
			} else if (animcount != 13 && animcount != 25)
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand1Attack") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand2Attack")) {
			if (animcount == 13 && soundplayed == false) {
				source.pitch = Random.Range (1.0F, 1.25F);
				source.PlayOneShot (onwater ? Largesplash : Bigstep, 0.5f);
				soundplayed = true;
				...
				source.PlayOneShot (onwater ? Largesplash : Bigstep, 0.5f);
				soundplayed = true;
			} else if (animcount != 13 && animcount != 15 && animcount != 21)
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step1+") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step2+") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step2ToStand1C") ||
			...
			if (animcount == 3 && soundplayed == false && (
				...
				if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step1Attack") ||
				    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Step2Attack")) {
					source.pitch = Random.Range (1.0F, 1.25F);
			...
			if (animcount == 25 && soundplayed == false) {
				...
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand1ToWalk")) {
			if (animcount == 15 && soundplayed == false) {
				source.pitch = Random.Range (1.0F, 1.25F);
				source.PlayOneShot (onwater ? Largesplash : Bigstep, 0.5f);
				soundplayed = true;
				...
				source.PlayOneShot (onwater ? Largesplash : Bigstep, 0.5f);
				soundplayed = true;
			} else if (animcount != 15 && animcount != 27)
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand2ToWalk")) {
			if (animcount == 20 && soundplayed == false) {
				source.pitch = Random.Range (1.0F, 1.25F);
				source.PlayOneShot (onwater ? Largesplash : Bigstep, 0.5f);
				soundplayed = true;
			...
			if (animcount != 20)
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|WalkToStand2")) {
			if (animcount == 15 && soundplayed == false) {
				source.pitch = Random.Range (1.0F, 1.25F);
				source.PlayOneShot (onwater ? Largesplash : Bigstep, 0.5f);
				soundplayed = true;
				...
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand1ToRun")) {
			if (animcount == 13 && soundplayed == false) {
				source.pitch = Random.Range (1.0F, 1.25F);
				source.PlayOneShot (onwater ? Largesplash : Bigstep, 0.5f);
				soundplayed = true;
				...
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Walk") ||
		           anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Walk") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Run") ||
		           anim.GetNextAnimatorStateInfo (0).IsName ("Rex|Run") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|RunGrowl") ||
		           anim.GetNextAnimatorStateInfo (0).IsName ("Rex|RunGrowl") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|WalkGrowl") ||
		           anim.GetNextAnimatorStateInfo (0).IsName ("Rex|WalkGrowl") ||
			...
			if (animcount == 0 && soundplayed == false) {
				...
				if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|WalkGrowl")) {
					source.PlayOneShot (Rex1, 1.0f);
				} else if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|RunGrowl")) {
					source.PlayOneShot (Rex2, 1.0f);
				} else if (anim.GetNextAnimatorStateInfo (0).IsName ("Rex|WalkAttackA") ||
				           anim.GetNextAnimatorStateInfo (0).IsName ("Rex|WalkAttackB") ||
				           anim.GetNextAnimatorStateInfo (0).IsName ("Rex|RunAttackA") ||
				           anim.GetNextAnimatorStateInfo (0).IsName ("Rex|RunAttackB")) {
					source.PlayOneShot (Carngrowl1, 1.0f);
				...
				source.PlayOneShot (Bite, 0.75f);
				soundplayed = true;
			} else if (animcount != 0 && animcount != 15 && animcount != 20)
				soundplayed = false;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|EatB")) {
			if (animcount == 1 && soundplayed == false) {
				...
				soundplayed = false;
		} else if (!isdead && (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Die1") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Die2"))) {
			if (animcount == 0 && soundplayed == false) {
				...
				soundplayed = true;
			} else if (animcount != 0 && animcount != 20)
				soundplayed = false;
			if (animcount > 20)
				isdead = true;
		} else if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Rise1") ||
		           anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Rise2")) {
			isdead = false;
...
//				}
	...
	void LateUpdate ()
	{
		...
		if (anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Die1") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Die2") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Rise1") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Rise2") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|Stand2ToSleep") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|SleepToStand2") ||
		    anim.GetCurrentAnimatorStateInfo (0).IsName ("Rex|SleepLoop"))
			rg.isKinematic = true;
		else
